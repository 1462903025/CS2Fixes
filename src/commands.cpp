...
WeaponMapEntry_t WeaponMap[] = {
	...
	{{"m249"},							"weapon_m249",			"M249",				7000, 14, GEAR_SLOT_RIFLE},
	{{"negev"},							"weapon_negev",			"Negev",			10000, 28, GEAR_SLOT_RIFLE},
	...
	{{"hegrenade", "he"},				"weapon_hegrenade",		"HE Grenade",		10000, 44, GEAR_SLOT_GRENADES, 1},
	{{"molotov"},						"weapon_molotov",		"Molotov",			5000, 46, GEAR_SLOT_GRENADES, 1},
...
void ParseWeaponCommand(const CCommand& args, CCSPlayerController* player)
{
	...
	ClientPrint(player, HUD_PRINTTALK, CHAT_PREFIX"\xE6\x82\xA8\xE5\xB7\xB2\xE8\xB4\xAD\xE4\xB9\xB0 %s \xE8\x8A\xB1\xE8\xB4\xB9\xE4\xBA\x86 $%i", weaponEntry.szWeaponName, weaponEntry.iPrice);
}
